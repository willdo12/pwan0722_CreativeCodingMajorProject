class Sky {
  constructor() {
    //Indicate whether it is daytime.inspiration（https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Classes/constructor）
    this.dayTime = true
  ...
  sun() {
    ...
    if (sunY < 0) {
      ...
      // Change the blend mode.inspiration：https://p5js.org/reference/#/p5/blendMode
      blendMode(ADD)
      for (let i = 0; i < 20; i++) {
